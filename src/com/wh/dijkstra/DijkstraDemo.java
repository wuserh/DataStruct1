...
public class DijkstraDemo {
    ...
    public static void main(String[] args) {
        ...
        matrix[0] = new double[]{N, AB, AC, AD};
        matrix[1] = new double[]{AB, N, BC, BD};
        matrix[2] = new double[]{AC, BC, N, CD};
        matrix[3] = new double[]{AD, BD, CD, N};
        //创建 Graph对象
...
class Graph {
    ...
    // 构造器
    public Graph(char[] vertex, double[][] matrix) {
        this.vertex = vertex;
        this.matrix = matrix;
    }
...
class VisitedVertex {
     ...
     * @param len
     */
    public void updateDis(int index, double len) {
        dis[index] = len;
    }
